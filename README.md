...
A Rust implementation of [ORB-SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3), a Visual-Inertial SLAM system.
...
- 🦀 Pure Rust implementation with OpenCV bindings
...
Run these to tell the Rust compiler where libclang and OpenCV are located:
